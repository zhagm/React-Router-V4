          ...
          <Row className="row-grid align-items-center">
            <Col className="order-md-2" md="6">
              <img
                ...
                src={`${ASSETS_URL}/img/theme/promo-1.png`}
              />
            </Col>
          ...
          <Row className="row-grid align-items-center">
            <Col md="6">
              <Card className="bg-default shadow border-0">
                <CardImg
                  alt="..."
                  src={`${ASSETS_URL}/img/theme/img-1-1200x1000.jpg`}
                  top
                />
            ...
            <Col className="order-lg-2 ml-lg-auto" md="6">
              <div className="position-relative pl-md-5">
                <img
                  ...
                  src={`${ASSETS_URL}/img/ill/ill-2.svg`}
                />
              </div>
            </Col>
            ...
            <Col className="mb-5 mb-lg-0" lg="3" md="6">
              <div className="px-4">
                <img
                  ...
                  src={`${ASSETS_URL}/img/theme/team-1-800x800.jpg`}
                  style={{ width: "200px" }}
                />
            ...
            <Col className="mb-5 mb-lg-0" lg="3" md="6">
              <div className="px-4">
                <img
                  alt="..."
                  className="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                  src={`${ASSETS_URL}/img/theme/team-3-800x800.jpg`}
                  style={{ width: "200px" }}
                />
                <div className="pt-4 text-center">
                  <h5 className="title">
            ...
            <Col className="mb-5 mb-lg-0" lg="3" md="6">
              <div className="px-4">
                <img
                  alt="..."
                  className="rounded-circle img-center img-fluid shadow shadow-lg--hover"
                  src={`${ASSETS_URL}/img/theme/team-4-800x800.jpg`}
                  style={{ width: "200px" }}
                />
                <div className="pt-4 text-center">
                  <h5 className="title">
